...
**cli_interface.md**
The Click-based command-line interface. Documents all options and arguments, local ReAct and parallel execution modes, Rich console output, error handling, logging integration, and all Makefile targets.
